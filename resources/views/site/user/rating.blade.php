...
<section class="user-page user-rating">
<div class="container">
    ...
    @endif
                        ...
                        <div class="contact-rate">
                            <a class="btn-borderless profile_btn_desk rate_btn" href="{{route('add_rate',$user->id)}}">@lang('site.add_rate')</a>
                        </div>
                        @endif
                </div>
            </div>
        <div class="userMain" id="userRate">
            <div class="singleContent rate_wrapper">
                <div class="filter_rates">
                    <div class="">
                        ...
                        <span>{{$countPositeve!=null?$countPositeve .'تقييم إجابى ':'لا يوجد تقييم '}}</span>
                    </div>
                </div>
                @foreach($user->userRate as $ratee)
                    <div class="ratingbox">
                        <div class="upperContent">
                            <span class="username">
                                <a href="#">
                                    ...
                                    <span>{{$ratee->user->name}}</span>
                            </a>
                            </span>
                            <span class="left_contnet">
                                <span class="the_date">{{$ratee->created_at->year}}-{{$ratee->created_at->month}}-{{$ratee->created_at->day}}</span>
                            <span class="status {{$ratee->recommend==0?'bad':'good'}}">
                                @if($ratee->recommend==1)
                        ...
                        <div class="rate_body">{{$ratee->notes}} </div>
                        @if(!is_null($ratee->image))
                            <div class="rate_image">
                                <a class="venobox vbox-item" data-gall="venue-gallery" href="{{url('/')}}{{ '/public/storage/'.$ratee->image }}">
                                    <img src="{{url('/')}}{{ '/public/storage/'.$ratee->image }}">
                                </a>
                            </div>
                        @endif
                    </div>
