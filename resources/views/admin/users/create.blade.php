            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="row">
                                <h4 class="m-t-0 header-title"><b>{{ __('add_user.add_new_user') }}</b></h4>
                                <form class="form-horizontal" role="form" action="{{ route('users.store') }}" enctype="multipart/form-data" method="post">
                                    @csrf
