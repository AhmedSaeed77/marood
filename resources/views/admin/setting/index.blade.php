            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="row">
                            ...
                            <div class="card-box">
                                <div class="row">
                                <h4 class="m-t-0 header-title"><b>@lang('dashboard.website_information') </b></h4>
                                <form class="form-horizontal" role="form" action="{{route('setting.update')}}" enctype="multipart/form-data" method="post">  
                                @csrf              
                                <!-- <input type="hidden" name="_method" value="put"/>   -->
                               @foreach($settings->where('for','basic') as $s) 
	                                            ...
	                                            <div class="form-group">
                                                    ...
                                                    @elseif($s->form_type=='select')
                                                      <select class="form-control" name="{{$s->name}}">
                                                            <option value="1" {{$s->value==1?'selected':''}}>ظهور اللوجو الخاص بالموقع  </option>
                                                            <option value="0" {{$s->value==0?'selected':''}}> ظهور اسم الموقع </option>
                                                      </select>
                                                    @endif
	                                                </div>
                                                </div>
