            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="row">
                                <h4 class="m-t-0 header-title"><b>{{ __('page_create.add_new_section') }}</b></h4>
                                <form class="form-horizontal" role="form" action="{{ route('pages.store') }}" enctype="multipart/form-data" method="post">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control required" value="{{ old('link') }}" name="link"/>
                                                    @if($errors->has('link'))
                                                        <strong class="alert-danger">{{ $errors->first('link') }}</strong>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control" name="show">
                                                        <option value="1">{{ __('page_create.show') }}</option>
                                                        <option value="0" selected>{{ __('page_create.hide') }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group" id="photo">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" value="{{ old('icon') }}" required name="icon" type="text"/>
                                    ...
                                    <textarea class="summernote" name="content">
                                        <h3>{{ __('dashboard.page_content_ar') }}</h3>
                                        {{ old('content') }}
                                    </textarea>
                                    </div>
                                    ...
                                    <textarea class="summernote" name="content_en">
                                        <h3>{{ __('dashboard.page_content_en') }}</h3>
                                        {{ old('content_en') }}
                                    </textarea>
                                    </div>
